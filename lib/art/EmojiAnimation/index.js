...
class EmojiAnimation {
    constructor(options = {}) {
        ...
        */
        ...
        this.__webView.loadHTML(`<html> <body><script type="text/javascript" >${jsHeart}</script><script type="text/javascript" >window.__emojis=${JSON.stringify(this.__emojis)}</script>
            <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
            <style> ${css(this.__emojiBoxWidth, this.__emojiWidth)} </style>     
            <!-- Start Content -->
    ...
    playEmoji(emojiIndex) {
        this.__webView.evaluateJS(`window.animateEmoji(${emojiIndex});`, (e) => { });
    }
}
