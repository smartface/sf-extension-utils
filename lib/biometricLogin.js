...
class BiometricLogin {
    /**
     * @param {object} options - Parameters to construct Fingerprint from
     ...
     * @param {boolean} options.confirmUseFingerprintOnFirstLogin=true - Specifies if biometric data is going to be prompted on first login
...
/**
 * Prompts first time fingerprint alert together with permissions.
