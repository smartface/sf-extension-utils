...
function loginWithFingerprint() {
    ...
    if (useFingerprintLogin && System.fingerPrintAvailable && storedUserName) {
        ...
        alert({
            title: global.lang.useFaceIDTitle || 'Use ${LOGIN_METHOD}',
            message: global.lang.useFingerprintMessage || 'Would you like to use ${LOGIN_METHOD} login on your future logins?',
            buttons: [{
                text: global.lang.yes || "Yes",
                type: AlertView.Android.ButtonType.POSITIVE,
                onClick: function() {
    ...
    function validateFingerPrint() {
        System.validateFingerPrint({
            android: {
                title: global.lang.scanFingerprintTitle || 'Login with ${LOGIN_METHOD}'
            },
            message: global.lang.scanFingerprintMessage || 'Scan your ${LOGIN_METHOD}',
            onSuccess: function() {
                return callback(null, {
                    password: tbPassword.text || storedPassword,
                    success: onSuccess
