 ...
 * @function fingerprint:updateCredentials
 * @public
 * @static
 * @param {string} [username] - User name to store
...
function updateCredentials(username, password) {
    password && Data.setStringVariable(dataKeys.password, encryptionFunction(password));
    username && Data.setStringVariable(dataKeys.username, encryptionFunction(username));
}
