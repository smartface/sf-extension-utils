 ...
 * @param {fingerprint:loginWithFingerprintCallback} options.callback is called when fingerprint login is called (Required)
...
function init(options) {
    ...
    typeof options.autoLogin !== "undefined" && expect(options.callback).to.be.a("boolean");
