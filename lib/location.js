...
const sfCorePackage = require("sf-core/package.json");
const satisfiesSfCoreVersion = semver.satisfies(semver.coerce(sfCorePackage.version), ">=3.0.1");
...
function getLocation(callback) {
    ...
    function getLocationAction() {
        ...
        Location.start(
            satisfiesSfCoreVersion ? [Location.Android.Provider.GPS, Location.Android.Provider.NETWORK] //post sf-core 3.0.1
            :
            Location.android.Provider.AUTO //backward compatibility
        );
    }
}
