 ...
 *     });
 */
function getLocation(callback, showSettingsAlert = true) {
    const getLocationPromise = getPermission({ androidPermission: Application.Android.Permissions.ACCESS_FINE_LOCATION, iosPermission: IOS_PERMISSIONS.LOCATION, showSettingsAlert })
