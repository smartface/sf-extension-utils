 ...
 * });
 */
function render({ customWidth, webView, base64pdf, zoomEnabled = false }) {
	const base64pdfParam = base64pdf.replace(/\n/g, '');
	const html = htmlTemplate
		.replace('__CUSTOM_WIDTH__', (customWidth || Screen.width) - 10)
		.replace('$maximumScale', zoomEnabled ? '6.0' : '1.0')
