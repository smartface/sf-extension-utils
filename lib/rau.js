 ...
 * @params {string} [options.user] information to be logged in RAU server for analytics
 * @params {function} [options.onBeforeRestart] callback event to fire just before restarting. After the syncrous call, app automatically restarts.
 * @static
 * @public
