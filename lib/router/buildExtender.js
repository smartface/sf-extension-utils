...
Application.onMaximize = function(onMaximize) {
    if (System.OS === "Android") {
        active.page && active.page.onShow && active.page.onShow();
    }
    onMaximize();
}.bind(null, Application.onMaximize);
...
const buildExtender = ({
    ...
    let builder = (router, route) => {
        ...
        Object.assign(pageInstance, { match, routeData, router, route, shouldExit: !!pageProps.shouldExit });
