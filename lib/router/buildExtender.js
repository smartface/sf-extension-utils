 ...
 * @param {string} options.pageName - name of the js file within the `pages` folder. This parameter is both page name as well as file name
...
const buildExtender = ({
    ...
    let builder = (router, route) => {
        ...
        Object.assign(pageInstance, { match, routeData, router, pageName, route, shouldExit: !!pageProps.shouldExit });
