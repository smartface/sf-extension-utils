            ...
            return ServiceCall.request(requestOptions)
                .then(response => {
                    ...
                    createAsyncTask(() => {
                        ...
                        .then(() => requestOptions.logEnabled && console.log("Successfully stored request & response ", cleanedRequestOptions, response))
                        .catch(err => requestOptions.logEnabled && console.error("Failed to store request & response ", errorHandler(err)));
                    return Promise.resolve(response);
                });
        };
