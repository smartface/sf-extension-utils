        ...
        return Promise.resolve().then(() => {
            ...
            while (idList.length > 0 && !isOffline()) {
                ...
                let executor = function(id, requestRecord, jobId) {
                    ...
                    let handledRequestOptions = this.offlineRequestHandler ? this.offlineRequestHandler(copy(requestOptions)) : requestOptions;
                    let serviceCallPromise = ServiceCall.request(handledRequestOptions)
                        .then(response => {
