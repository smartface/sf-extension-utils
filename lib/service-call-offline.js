            ...
            return ServiceCall.request(requestOptions)
                .then(response => {
                    ...
                    try {
                        ...
                        requestOptions.logEnabled && console.log("Successfully stored request & response ", cleanedRequestOptions, response);
                    }
                    catch (ex) {
                        requestOptions.logEnabled && console.error("Failed to store request & response ", errorHandler(ex));
                    }
                    return Promise.resolve(response);
                });
        };
