...
class Table {
    ...
    render() {
      ...
      `;
        ...
        <body>
            <table class="table ${this.tableOptions.tableClass ? this.tableOptions.tableClass : ''}" 
            ...
            ${this.tableOptions.rows.map((row) => `<tr class="table-row ${row.rowClass ? row.rowClass : ''}"
            ${row.rowStyles
                    ? `style="${Object.keys(row.rowStyles).map((key) => `${this.styleTypes[key]}:${row.rowStyles[key]};`).join('')}"` : ''
                }>
            ${row.columns.map((column) => `<td class="table-column ${column.columnClass ? column.columnClass : ''}"
                ${column.columnStyles
