 ...
 * @params {boolean} [options.rippleUseForeground] - iff this options is set to true, ripple effect added on top of the given target. No matter what given target contains, draw ripple effect over them. This option specfic to Android.
