 ...
 * @params {boolean} [options.enableRippleEffect] - Enables the ripple effect on given target. This option specfic to Android.
 * @params {number} [options.rippleDuration] - Ripple effect requires duration before performing given event. This option specfic to Android.
 * @params {boolean} [options.rippleUseForeground] - iff this options is set to true, ripple effect added on top of the given target. No matter what given target contains, draw ripple effect over them. This option specfic to Android. By default, ripple effect is given. 
 * @params {UI.Color} [options.rippleColor] - Sets the color to ripple effect. This option specfic to Android.
 * @params {UI.Color} [options.fadeColor] - Sets the color to fade effect. This option specfic to iOS.
 * @params {number} [options.fadeDuration] - Sets duration to fade effect. This option specfic to iOS. Default 0.2.
 * @params {number} [options.fadeMaxOpacity] - Sets maximum opacity to fade effect. This option specfic to iOS. Default 0.3.
 * @example
...
function addPressEvent(target, event, options) {
    ...
    options.rippleUseForeground = options.rippleUseForeground || false;
    options.rippleColor = options.rippleColor || Color.create("#d8d8d8");
    options.enableRippleEffect = options.enableRippleEffect || true;
    options.enableRippleEffect && applyRippleEffect.call(target, options.rippleUseForeground, options.rippleColor);
    ...
    target.__fadeEffectColor__ = options.fadeColor;
