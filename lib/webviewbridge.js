 ...
 * @param {string} [options.scheme = msg] - URI scheme in wevView to communicate with webview
 * @param {string|IO.File} source - source to inject bridge code
...
function customNavigate(options) {
    ...
    if (System.OS === "iOS") {
        ...
        userAgent && webView.nativeObject.setValueForKey(userAgent, "customUserAgent");
        ...
        userAgent && webView.nativeObject.getSettings().setUserAgentString(userAgent);
