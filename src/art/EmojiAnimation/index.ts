...
export default class EmojiAnimation {
  ...
  constructor(options: EmojiAnimationOptions) {
    this.__emojis = options.emojis || this.__emojis; // Array of emojis will be played
        ...
        <html> 
          <meta name="viewport" content="width=device-width, initial-scale=1" />
					<body style="margin: 0px; padding: 0px;">
						...
						<script type="text/javascript" >window.__emojis=${JSON.stringify(
              this.__emojis
            )}</script>
   ...
   */
  public playEmoji(emojiIndex: number, timing: number): void {
