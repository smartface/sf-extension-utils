...
export default abstract class RootDetection {
  ...
  static isRooted(): boolean {
    if (System.OS === System.OSType.IOS) {
      return (
        RootDetection.checkPathsForIOS() ||
        RootDetection.checkSchemes() ||
        RootDetection.checkRootAccessGainedForIOS()
      );
    } else {
      return (
        RootDetection.checkPathsForAndroid() ||
        RootDetection.checkSuBinaryExistance() ||
        RootDetection.checkRootAccessGainedForAndroid()
      );
    }
  }
